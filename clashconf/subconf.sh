...
# 替换原来的自动选择
sed -i "s|custom_proxy_group=♻️ 自动选择\`url-test\`.\*\`http://www.gstatic.com/generate_204\`300,,50|♻️ 自动选择\`url-test\`(^(?!.*(回家|home|back)).*)\`http://www.gstatic.com/generate_204\`300,,50|" clashconf.ini
